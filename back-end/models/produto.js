...
class Produto {
  ...
  static async insert(data) {
    try {
      const connect = await db.connect();
      const sql = "INSERT INTO produtos(titulo, dataCadastro, preco, descricao, imagem) VALUES ($1, $2, $3, $4, $5);";
  ...
  static async update(id, data) {
    try {
      const connect = await db.connect();
      const sql = "UPDATE produtos SET titulo = $1, dataCadastro = $2, preco = $3, descricao = $4, imagem = $5 WHERE id = $6";
